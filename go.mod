module github.com/radiohead/grafana-sdk-example
...
replace (
	...
	github.com/grafana/grafana-app-sdk => /Users/igor/Code/grafana/grafana-app-sdk
)

require (
	github.com/grafana/grafana-app-sdk v0.14.7
